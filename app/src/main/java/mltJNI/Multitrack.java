...
public class Multitrack extends Producer {
  ...
  public int insert(Producer producer, int index) {
    return mltJNI.Multitrack_insert(swigCPtr, this, Producer.getCPtr(producer), producer, index);
  }

  public int disconnect(int index) {
    return mltJNI.Multitrack_disconnect(swigCPtr, this, index);
  }
